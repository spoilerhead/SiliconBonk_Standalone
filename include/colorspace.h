...
#define WHITEi ((1<<QuantumDepth)-1)
#define BLACKi 0

#define f_itof ((1<<QuantumDepth)-1.f)  //float to int scale factor
#define ITOF(v) ((v)*(1.f/f_itof))
#define FTOI(v) ( clipi ((v) * f_itof,BLACKi,WHITEi) )//add clip

...
int main (int argc, char **argv) {
    ...
    try {
        ...
        cmsHPROFILE imgProfile = cmsOpenProfileFromMem(ICCBlob.data(), ICCBlob.length());
        if(imgProfile == NULL) {
        ...
        cmsHTRANSFORM toWorkspace = cmsCreateTransform(imgProfile, TYPE_RGB_FLT, workingSpace, TYPE_RGB_FLT, INTENT_PERCEPTUAL, 0);
        if(toWorkspace == NULL) {
            cout << "Failed to create toWorkspace" << endl;
        }  
        cmsHTRANSFORM fromWorkspace = cmsCreateTransform(workingSpace, TYPE_RGB_FLT, imgProfile, TYPE_RGB_FLT, INTENT_PERCEPTUAL, 0);
        ...
        for(size_t i = 0; i < width*height ; i++) {
            ...
            cmsDoTransform(fromWorkspace,&rgb, &rgb,1);
            ///---------------------------------------------------------
